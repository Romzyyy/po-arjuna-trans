                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 font-13 text-danger"><i class="bx bxs-down-arrow align-middle"></i>$24
                                        from last week</p>
                                </div>
                                <div class="widgets-icons rounded-circle text-white ms-auto bg-gradient-voilet"><i
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons rounded-circle text-white ms-auto bg-gradient-branding">
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons rounded-circle text-white ms-auto bg-gradient-kyoto"><i
